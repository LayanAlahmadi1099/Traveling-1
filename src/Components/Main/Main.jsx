...
const Data =[
    ...
    },
    {
        ...
        grade: 'CULTURAL RELAX',
        fees:'$700',
        description: 'One of the most remarkable Australian natural gifts is the Great Barrier Reef. The hallmark of this place is "lavishi" and "beautyl". Always interesting to be in this place',
    },
    {
        id:4, 
        imgSrc: img4, 
    ...
    },
    {
        ...
        grade: 'CULTURAL RELAX', 
        fees: '$500',
        description: 'Bali is an Indonesian Island and one of the best holiday destindtions in the Indonesian archipelago. Bali is known for its volcanic mountains, history, art & culture, food, temples and beautiful sandy beaches.'
    },
]
...
const Main = () => {
    ...
    return (
        <section className='main cotainer section'>
            ...
            <div className="secContenet grid">
                        ...
                        return( 
                            ...
                            className="singledescription">
                                ...
                                <div className="cardInfo">
                                    ...
                                    <span className='continent graid'>
